...
class GlobalSettingController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('GlobalSetting');
	...
	{
		$model=new GlobalSetting('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['GlobalSetting']))
			$model->attributes=$_GET['GlobalSetting'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='global-setting-form')
		{

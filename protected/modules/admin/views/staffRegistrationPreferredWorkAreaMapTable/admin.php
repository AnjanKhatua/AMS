...
$('.search-form form').submit(function(){
	$('#staff-registration-preferred-work-area-map-table-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Staff Registration Preferred Work Area Map Tables</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'staff-registration-preferred-work-area-map-table-grid',

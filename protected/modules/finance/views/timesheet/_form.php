...
<div class="form">
    ...
    <?php if (!$model->isNewRecord) { ?>
        ...
        <div class="row">
            ...
            <?php echo $form->textField($model, 'invoice_date', array('required' => true, 'readonly' => 'readonly',)); ?>
    ...
    <?php if ($model->isNewRecord) { ?>
        <table>
            <tr>
                <td>
                    <?php echo $form->labelEx($model, 'staff_id'); ?>
                    <?php echo $form->textField($model, 'staff_id', array('size' => 10, 'maxlength' => 10, 'required' => true)); ?>
                    <?php echo $form->error($model, 'staff_id'); ?>
                </td>
                <td>
                    <?php echo $form->labelEx($model, 'invoice_date'); ?>
                    ...
                    $start_date = strtotime('last wednesday', $start_date);
                    $model->invoice_date = Utility::changeDateToUK(date("Y-m-d", $start_date));
                    ?>
                    <?php echo $form->textField($model, 'invoice_date', array('required' => true, 'readonly' => 'readonly',)); ?>
                    <?php echo $form->error($model, 'invoice_date'); ?>
                </td>
            ...
            <table id='shiftDiv' class="shift-create">
                <tr class="shiftRow">
                    <td>
                        ...
                        $selectedHospitalUnit = $model->hospital_unit_id;
                        ?>
                        <?php echo CHtml::dropDownList('Timesheet[hospital_unit_id][]', $selectedHospitalUnit, $la_allHospitalUnits, array('single' => 'single', 'class' => 'hospital_unit_id', 'required' => true)); ?>
                        <?php // echo $form->textField($model,'hospital_unit_id[]',array('class' => 'classSizes'));   ?>
                        <?php echo $form->error($model, 'hospital_unit_id'); ?>
                    </td>
                    <td>
                        ...
                        $selectedDate = $model->week_end_date;
                        ?>                                        
                        <?php echo CHtml::dropDownList('Timesheet[week_end_date][]', $selectedDate, $allDate, array('single' => 'single', 'class' => 'classSizes weekEndDate')); ?>
                        <?php // echo $form->textField($model,'week_end_date');   ?>
                        <?php echo $form->error($model, 'week_end_date'); ?>
                    </td>
                    <td>
...
//    $allJobType = JobTypeForFinance::model()->jobTypeOfFinance();
                        ...
                        $selectedJobType = $model->finance_job_type_id;
                        ?> 
                        <?php echo CHtml::dropDownList('Timesheet[finance_job_type_id][]', $selectedJobType, $allJobType, array('single' => 'single', 'class' => 'classSizes jobType', 'required' => true)); ?>
                    ...
                    <td>
                        <?php echo $form->labelEx($model, 'monday'); ?>
                        <?php echo $form->textField($model, 'monday[]', array('class' => 'classSize monday', 'required' => true)); ?>
                        <?php echo $form->error($model, 'monday'); ?>
                    </td>
                    <td>
                        <?php echo $form->labelEx($model, 'tuesday'); ?>
                        <?php echo $form->textField($model, 'tuesday[]', array('class' => 'classSize tuesday', 'required' => true)); ?>
                        <?php echo $form->error($model, 'tuesday'); ?>
                    </td>
                    <td>
                        <?php echo $form->labelEx($model, 'wednesday'); ?>
                        <?php echo $form->textField($model, 'wednesday[]', array('class' => 'classSize wednesday', 'required' => true)); ?>
                        <?php echo $form->error($model, 'wednesday'); ?>
                    </td>
                    <td>
                        <?php echo $form->labelEx($model, 'thursday'); ?>
                        <?php echo $form->textField($model, 'thursday[]', array('class' => 'classSize thursday', 'required' => true)); ?>
                        <?php echo $form->error($model, 'thursday'); ?>
                    </td>
                    <td>
                        <?php echo $form->labelEx($model, 'friday'); ?>
                        <?php echo $form->textField($model, 'friday[]', array('class' => 'classSize friday', 'required' => true)); ?>
                        <?php echo $form->error($model, 'friday'); ?>
                    </td>
                    <td>
                        <?php echo $form->labelEx($model, 'saturday'); ?>
                        <?php echo $form->textField($model, 'saturday[]', array('class' => 'classSize saturday', 'required' => true)); ?>
                        <?php echo $form->error($model, 'saturday'); ?>
                    </td>
                    <td>
                        <?php echo $form->labelEx($model, 'sunday'); ?>
                        <?php echo $form->textField($model, 'sunday[]', array('class' => 'classSize sunday', 'required' => true)); ?>
                        <?php echo $form->error($model, 'sunday'); ?>
                    </td>
                    <td>
                        <?php echo $form->labelEx($model, 'exp'); ?>
                        <?php echo $form->textField($model, 'exp[]', array('class' => 'classSize', 'required' => true)); ?>
                        <?php echo $form->error($model, 'exp'); ?>
                    </td>
                    <td>
                        <?php echo $form->labelEx($model, 'note'); ?>
    ...
    <div class="row buttons">
        <?php echo CHtml::submitButton($model->isNewRecord ? 'Create' : 'Save', array('id' => 'checkDuplicate')); ?>
    </div>

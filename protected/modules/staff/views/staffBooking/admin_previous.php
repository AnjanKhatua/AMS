...
//	array('label'=>'Create Staff Booking', 'url'=>array('create')),
        //array('label'=>'Manage Upcoming Confirm Booking', 'url'=>array('admin')),
);

Yii::app()->clientScript->registerScript('search_previous', "
...
<h1>Previous confirmed shifts</h1>
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'dataProvider' => $model->search_previous(),
    'filter' => $model,
    'columns' => array(
//		'booking_id',
//		'staff_request_id',
        ...
        array(
            ...
            'buttons' => array
                ...
                'quote' => array
                    (
                    'label' => 'View Details',
                    'url' => 'Yii::app()->createUrl("staff/staffBooking/ViewPrevious", array("id"=>$data->booking_id))',

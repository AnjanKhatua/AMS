...
Yii::app()->clientScript->registerScript('search_cancel', "
...
<h1>Cancelled confirmed shifts</h1>
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'dataProvider' => $model->search_cancel(),
    'filter' => $model,
    'columns' => array(
//		'booking_id',
//		'staff_request_id',
        ...
        array(
            ...
            'buttons' => array
                ...
                'quote' => array
                    (
                    'label' => 'View Details',
                    'url' => 'Yii::app()->createUrl("staff/staffBooking/ViewCancel", array("id"=>$data->booking_id))',

 ...
 */
class StaffHoliday extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('staff_id, start_date, end_date', 'required', 'message' => 'Please enter {attribute}!'),
    ...
    public function search() {
        ...
        $criteria->compare('staff_id', $_SESSION['logged_user']['id']);
     ...
     * @return StaffHoliday the static model class
     */

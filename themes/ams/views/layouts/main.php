...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo $baseUrl;?>/img/icons/transparentlogo1.gif">
...
//                      $cs->registerScriptFile($baseUrl.'/js/script.js');
	...
	?>
        ...
        <link rel='stylesheet' href='<?php echo $baseUrl;?>/js/fullcalendar-2.8.0/fullcalendar.css' />
		<script type="text/javascript" src='<?php echo $baseUrl;?>/js/moment.js'></script>
		<script type="text/javascript" src='<?php echo $baseUrl;?>/js/fullcalendar-2.8.0/fullcalendar.js'></script>

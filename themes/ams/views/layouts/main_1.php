...
<html lang="en">
  <head>
	...
	<?php  
      ...
      <link rel="alternate stylesheet" type="text/css" media="screen" title="style2" href="<?php echo Yii::app()->baseUrl;?>/css/bootstrap.min.css" />
...
//                      $cs->registerScriptFile($baseUrl.'/js/script.js');
	...
	?>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="<?php echo $baseUrl;?>/css/styles.css" />
        ...
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl?>/js/jquery.datetimepicker.full.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl?>/js/jquery.datetimepicker.full.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl?>/js/jquery.datetimepicker.min.js"></script>
        
        <link type="text/css" href="<?php echo Yii::app()->baseUrl?>/css/jquery.datetimepicker.min.css" />

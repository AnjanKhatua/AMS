...
//				timeHtml = '<span class="fc-time">' + htmlEscape(timeText) + '</span>';
             ...
             * @type String Anjan
             */
            var str = htmlEscape(event.title || '');
            var n = str.indexOf("/");
            var firstCharecter = str.charAt(n-1);
            var secondCharecter = str.charAt(n+1);
            if(firstCharecter != secondCharecter){
                titleHtml =
			'<span class="fc-title">' +
				(htmlEscape(event.title || '') || '&nbsp;') + // we always want one line of height
			'</span>';
            }else if(firstCharecter == secondCharecter){
                titleHtml =
			'<span class="fc-title fullFill">' +
				(htmlEscape(event.title || '') || '&nbsp;') + // we always want one line of height
			'</span>';
            }
//		titleHtml =
